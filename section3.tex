...
\begin{satz}[Beziehung zur Bestapproximation] \beginwithlist
	\begin{enumerate}
...
\begin{satz}[Duale a-posteriori Fehlerschranke \& Effektivitätsschranke] \beginwithlist
	\begin{enumerate}
		\item
			\[
...
\begin{satz}[Primal-dualer Ausgabefehlerschätzer]
	Für alle $\mu$ gilt
	\[
