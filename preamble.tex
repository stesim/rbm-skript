...
\newcommand{\LNI}{\mathcal{L}_{N,I}}
\newcommand{\LE}{\mathcal{L}_E}
\newcommand{\Leins}{\mathcal{L}_1}
\newcommand{\Lzwei}{\mathcal{L}_2}
\newcommand{\LNE}{\mathcal{L}_{N,E}}
...
\newcommand{\eprob}[1][\mu]{\big(E(#1)\big)}
\newcommand{\erprob}[1][\mu]{\big(E_N(#1)\big)}
